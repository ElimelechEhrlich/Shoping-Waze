# קבלות חכמות (Shopping Waze) — תיעוד בעברית

> **התיעוד הראשי של הפרויקט באנגלית:** ראו [`README.md`](README.md) — זה הקובץ שמופיע כברירת מחדל ב-GitHub ומומלץ לתרומות בינלאומיות.
...
**תיעוד מלא באנגלית:** [`README.md`](README.md)
