  ...
  return (
    <div className="min-h-screen bg-zinc-100" dir="rtl">
      ...
      <main className="max-w-lg mx-auto px-4 py-8 space-y-6">
        ...
        {/* ── דירוג אמון ─────────────────────────────────────── */}
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-md shadow-lg p-5 text-white">
        ...
        {/* ── אווטר ────────────────────────────────────────────── */}
        <div className="bg-white rounded-md border border-zinc-200 shadow-sm p-6 flex flex-col items-center gap-4">
        ...
        {/* ── טופס עריכה ───────────────────────────────────────── */}
        <div className="bg-white rounded-md border border-zinc-200 shadow-sm p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              value={user?.email || ""}
              disabled
              className="w-full border border-zinc-200 rounded-sm px-4 py-2.5 text-sm
          ...
          <button
            ...
            className="w-full py-3 rounded-sm bg-zinc-900 hover:bg-zinc-800
            ...
            <div className="px-5 pb-5 pt-2 space-y-3">
              <div>
                ...
                <select
                  ...
                  className="w-full border border-slate-200 rounded-sm px-3 py-2.5 text-sm bg-white
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full border border-slate-200 rounded-sm px-3 py-2.5 text-sm resize-y min-h-[100px]
                    focus:outline-none focus:ring-2 focus:ring-amber-400"
                />
              </div>
              <button
                ...
                className="w-full py-2.5 rounded-sm bg-amber-500 hover:bg-amber-600 text-white text-sm font-semibold
