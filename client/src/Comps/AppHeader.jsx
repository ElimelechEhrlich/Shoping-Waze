...
//   • האווטר ליד ההמבורגר — ב-RTL שניהם מוצגים בצד שמאל; NavDrawer נצמד ל-left-0
// ─────────────────────────────────────────────────────────────────────────────
...
const AppHeader = ({ onMenuClick }) => {
  ...
  return (
    <header className="bg-white border-b border-zinc-200 px-4 py-3 flex items-center justify-between sticky top-0 z-50">
